...
public class MainController {
    ...
    @PostMapping("/quiz1")
    public String quiz(@ModelAttribute CreateExam createExam, Model m, RedirectAttributes ra) throws ParseException, InterruptedException {
        createExam.setTime(createExam.getNumQuestion() == 35 ? 45 : 60);
        List<Question> questions = questionService.findBySubAndClass(createExam.getSubject().getId());
        ...
        QuestionForm qForm = qService.getQuestionsBySubAndClass(createExam.getSubject().getId(),
